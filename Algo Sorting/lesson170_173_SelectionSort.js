...
//Again, the time complexity is O(n^2), as you have nested for loops;

//SELECTION SORT -> DON'T USE IT
...
function selectionSort(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    let indexOfSmallest = i;//1st time, smallest is at index0
    ...
    for (let j = i+1; j < array.length; j++) {
      ...
      //once a smaller one is found, remember that index and continue;
      if (array[j] < array[indexOfSmallest]) indexOfSmallest = j;
    }

    array = swap(array, i, indexOfSmallest ) ; 
  }
}
