...
const mergeSortedArrays = function (arr1, arr2) {
  ...
  if( !Array.isArray(arr1) || !Array.isArray(arr2) || arr1.some(isNaN) || arr2.some(isNaN) ) {
    return "Invalid data";
  }
  ...
  //if it is lower or equal then 1st el of 2nd array, you add it to the final array and remove it from 1st array; now you do the same thing; in case it is not lower or equal, then you add the 1st el of the 2nd array and remove it from there; and so on until you deplete the arrays;
